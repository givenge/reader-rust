...
pub fn build_router(state: AppState) -> Router {
    let api = Router::new()
        ...
        .route("/reader3/getAiBookMemory", get(handlers::get_ai_book_memory).post(handlers::get_ai_book_memory))
        .route("/reader3/saveAiBookMemory", post(handlers::save_ai_book_memory))
        .route("/reader3/deleteAiBookMemory", post(handlers::delete_ai_book_memory))
